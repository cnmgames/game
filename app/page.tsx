        ...
        <div className="game-container">
          <div className="flex items-center justify-between gap-2 mb-6 flex-wrap">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              ...
              {isLoggedIn ? (
                <Link href="/user" className="nav-pill !bg-pink-500/20 !border-pink-400/40 !text-pink-200 hover:!bg-pink-500/30 transition">
                  {userEmail ? userEmail.split("@")[0] : "用户中心"}
                </Link>
              ) : (
                <>
                  <Link href="/login" className="nav-pill hover:!bg-white/10 transition">登录</Link>
                  <Link href="/register" className="nav-pill !bg-pink-500/20 !border-pink-400/40 !text-pink-200 hover:!bg-pink-500/30 transition">注册</Link>
                </>
              )}
            </div>
          </div>
